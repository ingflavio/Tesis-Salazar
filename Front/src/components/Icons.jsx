function HomeIcon() {
  return (
    <svg viewBox="0 0 24 24" strokeWidth="0.2">
...
function ProfileIcon() {
  return (
    <svg viewBox="0 0 24 24" strokeWidth="1.3">
...
function QRScanIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} >
      ...
      <g transform="translate(12,12) scale(0.55) translate(-12,-10)">
...
function ChevronICon(){
  return (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={3.5} stroke="currentColor" className="size-6">
...
function Eye(){
  return (
    <svg fill="none" viewBox="0 0 24 21" strokeWidth={1.5} stroke="currentColor" className="size-6">
...
function QrIcon(){
  return <svg viewBox="-20 -50 537 614">
